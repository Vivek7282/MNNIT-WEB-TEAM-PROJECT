    ...
    Change Permission
        ...
        <div class="col-lg-12">
         ...
         <form    class="form-horizontal" method="post" action="function.php">
                ...
                <label for="type">Permission To Add Courses &emsp; &emsp;   &nbsp</label>
                ...
                <div class="text-center">
                  <button type="submit" class="btn btn-primary" value="Add Course" name="addCourses1">Add Course Permission</button>
